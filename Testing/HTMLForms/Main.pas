...
<body>
  <div class="long-list"> <!-- Container for the input field and dropdown -->
    ...
    <!-- The dropdown list will be created by the JavaScript and inserted here -->
  </div>
  <script>
...
ccss = '''
.long-list {
  position: relative; /* Ensure the input's container is relatively positioned */
...
.long-list input[type="text"] {
  ...
  padding: 8px;
  padding-right: 24px; /* Make room for the arrow image */
  border: 1px solid #ccc;
  border-radius: 4px;
  background: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M7 10l5 5 5-5z" fill="%23000"/></svg>') no-repeat right 8px center; /* Arrow SVG */
  background-size: 16px 16px; /* Size of the arrow */
  cursor: pointer; /* Change cursor to indicate this is a dropdown */
